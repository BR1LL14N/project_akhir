<div class="w-60 bg-gray-800 text-gray-100 h-screen">
    <div class="p-4 font-bold text-lg">Menu</div>
    <ul class="mt-4 space-y-2">
        <li class="group">
            <!-- MODUL ROLE DEFAULT SELALU TERIKIR SETIAP SIDEBAR TERKLIK -->
            <a href="index.php?modul=role">
                <div class="px-4 py-2 hover:bg-gray-700 cursor-pointer group-hover:bg-gray-700 flex items-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M19.1944 9.07897V7.82129C19.1944 7.2833 18.9779 6.76734 18.5924 6.38692C18.2069 6.0065 17.684 5.79279 17.1389 5.79279H6.8611C6.31593 5.79279 5.79309 6.0065 5.4076 6.38692C5.02211 6.76734 4.80554 7.2833 4.80554 7.82129V9.07897" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M6.86108 5.79276V4.77851C6.86108 4.24051 7.07765 3.72456 7.46314 3.34414C7.84863 2.96372 8.37147 2.75 8.91664 2.75H15.0833C15.6285 2.75 16.1513 2.96372 16.5368 3.34414C16.9223 3.72456 17.1389 4.24051 17.1389 4.77851V5.79276" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M17.92 8.83551H6.08C4.24089 8.83551 2.75 10.3068 2.75 12.1217V17.9638C2.75 19.7787 4.24089 21.25 6.08 21.25H17.92C19.7591 21.25 21.25 19.7787 21.25 17.9638V12.1217C21.25 10.3068 19.7591 8.83551 17.92 8.83551Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        <path d="M7.88892 12.8925V13.9068C7.88892 14.4448 8.10548 14.9607 8.49097 15.3411C8.87647 15.7216 9.3993 15.9353 9.94447 15.9353H14.0556C14.6008 15.9353 15.1236 15.7216 15.5091 15.3411C15.8946 14.9607 16.1111 14.4448 16.1111 13.9068V12.8925" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>

                    <span class="ml-4">Master Data Role</span>
                </div>
            </a>
                ...
                <a href="index.php?modul=user&fitur=role">
                    <div class="flex items-center">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path d="M12 11.4559C14.404 11.4559 16.3529 9.50701 16.3529 7.10294C16.3529 4.69888 14.404 2.75 12 2.75C9.59594 2.75 7.64706 4.69888 7.64706 7.10294C7.64706 9.50701 9.59594 11.4559 12 11.4559Z" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                        </svg>

                        <span class="ml-4">Master Data User</span>
                    </div>
                </a>
            </div>
<!--            <ul class="ml-4 space-y-1 hidden group-hover:block">-->
            ...
            <a href="index_barang.php">
                <div class="px-4 py-2 hover:bg-gray-700 cursor-pointer group-hover:bg-gray-700 flex items-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M16.625 11.5531V7.3812C16.6261 6.7737 16.5074 6.17194 16.2756 5.61033C16.0439 5.04872 15.7037 4.53827 15.2745 4.10816C14.8449 3.67764 14.3345 3.33607 13.7726 3.10302C13.2107 2.86996 12.6083 2.75 12 2.75C11.3916 2.75 10.7893 2.86996 10.2274 3.10302C9.66549 3.33607 9.15511 3.67764 8.72549 4.10816C8.29628 4.53827 7.95608 5.04872 7.72435 5.61033C7.49262 6.17194 7.37391 6.7737 7.37499 7.3812L7.37499 11.5531" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>

                    <span class="ml-4">Master Data Barang</span>
                </div>
            </a>
        </li>
        <li class="group">
