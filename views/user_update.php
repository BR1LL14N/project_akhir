            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="index.php?modul=user&fitur=update" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="name" name="name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="nama user" required value = "<?= $user->username ?>">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="password" name="password" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="password user" required value = "<?= $user->password ?>">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select id="role_status" name="role_status" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
                            ...
                            <?php foreach ($listRole as $rolename){ ?>
                            <option value=<?php echo htmlspecialchars($rolename->nama_peran)?>>
                                <?php echo htmlspecialchars($rolename->nama_peran)?>
                            </option>
                            <?php } ?>
                        </select>
                    </div>
