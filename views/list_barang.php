        ...
        <div class="container mx-auto">
            ...
            <div class="mb-4">
                <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                    <a href="views/input_barang.php?modul=role&fitur=add">
                ...
                <table class="min-w-full bg-white grid-cols-1">
                    ...
                    <?php foreach($barangs as $barang) { ?>
                                <tr class="text-center">
                                    ...
                                    <td class="w-1/4 py-3 px-4"><?php echo htmlspecialchars(number_format($barang->harga_barang, 0, ',', '.')) ?></td>
                                    <td class="w-1/6 py-3 px-4"><?php echo htmlspecialchars($barang->jumlah_barang) ?></td>
                                    <td class="w-1/6 py-3 px-4">

                                        <div class="flex items-center space-x-2">
                                            <button class="bg-green-500 hover:bg-green-700 text-white font-bold py-1 px-2 rounded mr-2">
                                                <a href="index.php?modul=barang&fitur=edit&id=<?php echo $barang->id_barang ?>">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <button class="bg-red-500 hover:bg-red-700 text-white font-bold py-1 px-2 rounded mr-2">
                                                <a href="index.php?modul=barang&fitur=delete&id=<?php echo $barang->id_barang ?>" onclick="return confirm('Apakah Anda yakin ingin menghapus barang ini?')">
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
