...
// if(!$role) {
//     die("Role dengan ID tersebut tidak ditemukan.");
// }
            ...
            <div class="max-w-lg mx-auto bg-white p-6 rounded-lg shadow-lg">
                ...
                <form action="../index.php?modul=role&fitur=add" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="nama_peran" name="nama_peran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="" required>
                    </div>

                    <!-- Role Deskripsi -->
                    <div class="mb-4">
                        <label for="desc_peran" class="block text-gray-700 text-sm font-bold mb-2">Role Deskripsi:</label>
                        <textarea id="desc_peran" name="desc_peran" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="" rows="3" required></textarea>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input id="gaji" name="gaji" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value=""  required>
                    </div>
